<div class="menu_lateral">
        <a href="" class="home"><i class='bx bx-home'></i> Inicio</a>
            <nav class="menu1">
            <ul>
                <li><i class='bx bxs-user-voice' id="white"></i> <i class="white"> Categorias del foro</i>
                    <ul>
                        <li><a href="data/noregistro.php"><i class='bx bxs-school' ></i> <i class="p_1">Escuelas</i></a></li>
                        <li><a href="data/noregistro.php"><i class='bx bx-male'></i> <i class="p_1">Maestros</i> </a></li>
                    </ul>
                </li>
            </ul>
        </nav>
